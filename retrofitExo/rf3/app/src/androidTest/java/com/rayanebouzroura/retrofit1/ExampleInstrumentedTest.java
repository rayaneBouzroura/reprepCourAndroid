...
public class ExampleInstrumentedTest {
    ...
    //truc complex list test
    @Test
    public void test_ComplexList() throws IOException {

        Service service = RetrofitUtil.get();
        Call<List<ComplexResponse>> call = service.getComplexList();
        Response<List<ComplexResponse>> response = call.execute();
        List<ComplexResponse> resultat = response.body();
        String a = "A";
        //Log.i("RETROFIT",resultat.a+" "+resultat.b+" "+resultat.c);
    ...
    //test liste long
    @Test
    public void test_LongList() throws IOException {

        Service service = RetrofitUtil.get();
        Call<List<Long>> call = service.getLongList();
